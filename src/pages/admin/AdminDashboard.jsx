...
const sidebarTop = { xs: "56px", sm: "64px" };
...
const AdminDashboard = () => {
  ...
  const [pendingAdminAppsCount, setPendingAdminAppsCount] = useState(null);
  ...
  useEffect(() => {
    if (location.pathname === "/admin") {
      ...
      Promise.all([
        ...
        setPendingAdminAppsCount(adminApps.count ?? 0);
    ...
    >
      <Box
        sx={{
          ...
          width: "100%",
          height: "100%",
          background: theme.palette.mode === "light" ? "#f8fafc" : "#1e1e1e",
          boxShadow:
            theme.palette.mode === "light"
              ? "0 2px 12px 0 rgba(31,38,135,0.08)"
              : "none",
          ...
          >
            <Typography
              sx={{
                textAlign: "center",
                color:
                  theme.palette.mode === "light" ? "#1a237e" : "text.primary",
                opacity: { xs: 1, sm: 0.7 },
    ...
    <AdminSidebarContext.Provider value={{ onToggle: handleDrawerToggle }}>
      <Box
        sx={{
          ...
          background:
            theme.palette.mode === "light"
              ? "linear-gradient(135deg, #e3eafc 0%, #f4f6f8 100%)"
              : "background.default",
          overflowX: "hidden",
        }}
      >
          ...
          <Drawer
            ...
            sx={{
              ...
              [`& .MuiDrawer-paper`]: {
                ...
                position: "fixed",
                top: sidebarTop,
                height: `calc(100vh - ${sidebarTop.sm})`,
                p: 1,
                zIndex: 1199,
                transition: "width 0.45s cubic-bezier(0.4,0,0.2,1)",
              },
                  ...
                  <Grid item xs={12} sm={6} md={3}>
                    <Card
                      sx={{
                        ...
                        background:
                          theme.palette.mode === "light"
                            ? "linear-gradient(135deg, #fff4e5 0%, #fff8e1 100%)"
                            : "background.paper",
                        border:
                          theme.palette.mode === "light"
                            ? "1px solid #ffe0b2"
                  ...
                  <Grid item xs={12} sm={6} md={3}>
                    <Card
                      sx={{
                        ...
                        background:
                          theme.palette.mode === "light"
                            ? "linear-gradient(135deg, #f3e5f5 0%, #fbe9e7 100%)"
                            : "background.paper",
                        border:
                          theme.palette.mode === "light"
                            ? "1px solid #e1bee7"
                ...
                <Box
                  sx={{
                    ...
                    gridTemplateColumns: {
                      ...
                      sm: "1fr 1fr",
                      md: "1fr 1fr 1fr",
                      lg: "1fr 1fr 1fr", // Changed from 4 columns to 3
                    },
                    gap: 4,
                    gridAutoRows: "1fr",
                    width: "100%",
                    maxWidth: 1000, // Limit width to prevent overly stretched cards on massive screens
                    mx: "auto", // Center the grid container horizontally
                    mb: 4,
                  }}
                >
                  {adminMenu.map((item) => (
                      ...
                      <Card
                        sx={{
                          ...
                          "&:hover": {
                            ...
                            background:
                              theme.palette.mode === "light"
                                ? "linear-gradient(135deg, #e8eaf6 0%, #f4f6f8 100%)"
